...
class getSecurity_User_Provider_Concrete_InMemoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(['admin' => ['password' => '$2y$13$hGli/kQxgj2U.qhSzWBdHeufge9WS8Y9eoa.ywsR/y2lmNaYHOaL6', 'roles' => ['ROLE_ADMIN']], 'user' => ['password' => '$2y$13$SkpQxd1tCjl3bSboKsjF.OrI6Ncrgy6.YFa56tMA5m5gUWLZdmEhW', 'roles' => ['ROLE_USER']]]);
    }
}
